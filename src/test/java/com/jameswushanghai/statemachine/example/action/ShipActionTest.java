...
public class ShipActionTest {
    ...
    public void testDoActionSuccess() {
        ...
        // 执行动作
        String result = shipAction.doAction(context);

        // 验证结果
        assertEquals("SUCCESS", result);
        assertEquals("SUCCESS", context.get("shippingStatus"));
        assertNotNull(context.get("shippingTime"));
    }
    ...
    public void testDoActionMissingOrderId() {
        ...
        assertEquals("FAILED", context.get("shippingStatus"));
    ...
    public void testDoActionNullContext() {
        // 测试null上下文
        String result = shipAction.doAction(null);
