 ...
 * DeliverAction的测试类
 */
public class DeliverActionTest {
    ...
    public void testDoActionSuccess() {
        ...
        // 执行动作
        String result = deliverAction.doAction(context);

        // 验证结果
        assertEquals("SUCCESS", result);
        assertEquals("SUCCESS", context.get("deliveryStatus"));
        assertNotNull(context.get("deliveryTime"));
    }
    ...
    public void testDoActionMissingOrderId() {
        ...
        assertEquals("FAILED", context.get("deliveryStatus"));
    ...
    public void testDoActionNullContext() {
        // 测试null上下文
        String result = deliverAction.doAction(null);
